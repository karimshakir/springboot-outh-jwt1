...
* Run `gradle bootrun` to build and run the project or run the project from your ide(make sure you build it before running)# task-list-manager
# task-list-manager
# springboot-outh-jwt1
# springboot-outh-jwt1
